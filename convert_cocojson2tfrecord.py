    ...
    for json_file in glob.glob(path + '/*.json'):
        ...
        for image_idx in range(len(images)):
            ...
            for bbox_idx in range(len(bboxes[image_idx])):
                xmin = int(bboxes[image_idx][bbox_idx][0])
                ymin = int(bboxes[image_idx][bbox_idx][1])
                xmax = int(xmin + bboxes[image_idx][bbox_idx][2])
                ymax = int(ymin + bboxes[image_idx][bbox_idx][3])
